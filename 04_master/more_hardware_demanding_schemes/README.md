...
[`../../02_multilevel/`](../../02_multilevel/); the leak-limited ≈ 0.06 is computed in chapter 03. The figure is
regenerated by [`../master_figures.py`](../src/master_figures.py) (it writes `bench_dual_end.png` into this folder).*
